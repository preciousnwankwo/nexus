...
SRCS = $(SRC_DIR)/arena.c $(SRC_DIR)/string_table.c $(SRC_DIR)/lexer.c $(SRC_DIR)/ast.c $(SRC_DIR)/parser.c
OBJS = $(patsubst $(SRC_DIR)/%.c, $(BUILD_DIR)/%.o, $(SRCS))

LIB_OBJS = $(BUILD_DIR)/arena.o $(BUILD_DIR)/string_table.o $(BUILD_DIR)/lexer.o $(BUILD_DIR)/ast.o $(BUILD_DIR)/parser.o
